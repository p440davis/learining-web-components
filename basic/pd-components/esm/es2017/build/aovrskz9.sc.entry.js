...
class StockPrice {
    ...
    static get style() { return ".sc-pd-stock-price-h{display:inline-block;width:-webkit-max-content;width:-moz-max-content;width:max-content;margin-top:1rem;padding:.5rem;background-color:#2e8b57}.error.sc-pd-stock-price-h{background-color:#c71585}"; }
}
